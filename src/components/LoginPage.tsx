  ...
  return (
    <div className="login-overlay">
      ...
      <svg className="login-wave" viewBox="0 0 1440 320" preserveAspectRatio="none">
        <path fill="#4CAF50" fillOpacity="0.85" d="M0,64L48,69.3C96,75,192,85,288,101.3C384,117,480,139,576,122.7C672,107,768,53,864,53.3C960,53,1056,107,1152,106.7C1248,107,1344,53,1392,26.7L1440,0L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
      </svg>
    </div>
  )
}